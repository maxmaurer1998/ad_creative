...
- Effects tab: film grain (with a fine-to-coarse grain-size slider), vignette, and a warm "heritage" colour-grade, each applied across the whole composite (photo, fade, text and logo) — combine them for a premium/vintage-print finish
